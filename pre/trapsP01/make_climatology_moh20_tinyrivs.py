...
for riv in shifted:
    ...
    # get river index
    #riv_index = int(moh20_river_data_ds.where(moh20_river_data_ds['name'] == riv, drop=True)['source']) #old
    riv_index = int(moh20_river_data_ds.where(moh20_river_data_ds['name'] == riv, drop=True)['source'].item()) #kate
