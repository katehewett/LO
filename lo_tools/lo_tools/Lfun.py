...
def get_macc_s5cmd_env(current_user):
    ...
    And if they have more than one set of keys, they should enter the macc keys like Kate does 
    ...
    if current_user == 'kmhewett' or current_user == 'katehewett':
        ...
        s5cmd_env['S3_ENDPOINT_URL'] = os.environ.get('S3_ENDPOINT_URL', '')        # it is 'https://s3.kopah.uw.edu'
        return s5cmd_env
        ...
        # print error in main script and exit sending to macc storage on kopah 
        return None    
